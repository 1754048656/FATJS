...
public class CaptureScreenService extends Service {
    ...
    private void createNotificationChannel() {
        ...
        builder.setContentIntent(PendingIntent.getActivity(this, 0, nfIntent, PendingIntent.FLAG_IMMUTABLE)) // 设置PendingIntent
                .setLargeIcon(BitmapFactory.decodeResource(this.getResources(), R.drawable.logo3)) // 设置下拉列表中的图标(大图标)
                .setContentTitle("屏幕捕捉正在运行") // 设置下拉列表里的标题
                .setSmallIcon(R.drawable.logo3) // 设置状态栏内的小图标@mipmap/ic_launcher
